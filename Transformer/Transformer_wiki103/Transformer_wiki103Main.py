...
def main():
    ...
    if RESUME_TRAINING == False:
        ...
        checkpoint_data = torch.load('D:\mgovind\Transformer_wiki103\checkpoint\gptwk_model.pt')
    ...
    for i in tqdm.tqdm(range(start,NUM_BATCHES), mininterval = 10., desc = 'training'):
        ...
        if i % GENERATE_EVERY == 0:
            ...
            ckpt_path = os.path.join("D:\mgovind\Transformer_wiki103\checkpoint\gptwk_model.pt")
