...
import numpy as np
import torch
#from WK103Dataset import MyNLPDataSet
from WK103Dataset import WikitextDataset , MyNLPDataSet 
...
def get_loaders_enwiki8(seq_len, batch_size):
    # ---------prepare enwik8 data-----------
    with gzip.open('D:\mgovind\MinGPTARG\MinGPT\data\enwik8.gz') as file:
